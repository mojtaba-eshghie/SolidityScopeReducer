...
export declare class Assignment extends Expression {
    /**
    ...
    constructor(id: number, src: string, typeString: string, operator: string, leftHandSide: Expression, rightHandSide: Expression, raw?: any);
